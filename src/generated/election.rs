...
pub mod bully_client {
    ...
    #[derive(Debug, Clone)]
    pub struct BullyClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl BullyClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> BullyClient<InterceptedService<T, F>>
        where
        ...
        {
            BullyClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/election.Bully/Election");
        ...
        pub async fn announce_coordinator(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/election.Bully/AnnounceCoordinator",
            );
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        pub async fn ping(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/election.Bully/Ping");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("election.Bully", "Ping"));
            self.inner.unary(req, path, codec).await
        }
    }
}
/// Generated server implementations.
pub mod bully_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with BullyServer.
    #[async_trait]
    pub trait Bully: std::marker::Send + std::marker::Sync + 'static {
        /// Called by a node to notify higher-id nodes that it starts an election.
        async fn election(
            &self,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for BullyServer<T>
    where
        T: Bully,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/election.Bully/Election" => {
                    #[allow(non_camel_case_types)]
                    struct ElectionSvc<T: Bully>(pub Arc<T>);
                    impl<T: Bully> tonic::server::UnaryService<super::ElectionRequest>
                    for ElectionSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Bully>::election(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/election.Bully/AnnounceCoordinator" => {
                    #[allow(non_camel_case_types)]
                    struct AnnounceCoordinatorSvc<T: Bully>(pub Arc<T>);
                    impl<T: Bully> tonic::server::UnaryService<super::Coordinator>
                    for AnnounceCoordinatorSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Bully>::announce_coordinator(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/election.Bully/Ping" => {
                    #[allow(non_camel_case_types)]
                    struct PingSvc<T: Bully>(pub Arc<T>);
                    impl<T: Bully> tonic::server::UnaryService<super::PingRequest>
                    for PingSvc<T> {
                        type Response = super::PingResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Bully>::ping(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for BullyServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "election.Bully";
    impl<T> tonic::server::NamedService for BullyServer<T> {
